...
with open(home + '/NPI/code_output/figs/sims_con_lowE.pickle', 'wb') as handle:
    pickle.dump(sims_con, handle, protocol=pickle.HIGHEST_PROTOCOL)
with open(home + '/NPI/code_output/figs/sims_trt_lowE.pickle', 'wb') as handle:
...
plt.tight_layout()
plt.savefig(home + '/NPI/code_output/figs/sim_fig_mid.png', dpi=300)
