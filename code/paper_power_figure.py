...
with open('/Users/jsheen/Desktop/sims_con_lowE.pickle', 'wb') as handle:
    pickle.dump(sims_con, handle, protocol=pickle.HIGHEST_PROTOCOL)
with open('/Users/jsheen/Desktop/sims_trt_lowE.pickle', 'wb') as handle:
...
# Plotting --------------------------------------------------------------------
with open('/Users/jsheen/Desktop/sims_con.pickle', 'rb') as handle:
    sims_con = pickle.load(handle)
with open('/Users/jsheen/Desktop/sims_trt.pickle', 'rb') as handle:
...
for i in range(len(I_cons)):
    newList = [(x / 66000) for x in I_cons[i]]
    newList2 = [(x / 66000) for x in I_trts[i]]
    #plt.plot(list(range(len(I_cons[i]))), newList, color='orange', linewidth=0.5, alpha=0.5)
    #plt.plot(list(range(len(I_trts[i]))), newList2, color='grey', linewidth=0.5, alpha=0.5)
    ...
    ax1.set_ylabel('I / N')  
    #ax1.set_xlabel('Days after initial infection')     
    ...
    #ax1.legend(custom_lines, ['Control', 'Treatment'])
