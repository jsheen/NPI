...
for (param_set in param_sets) {
  ...
  sufficient_ncluster_res <- read.csv(paste0("~/Desktop/res/res_", tgt_R0, "_", N_cluster, "_", k_overdispersion, "_", effect, "_", expected_It_N, "_", nsample, "_ttest.csv"), header=F)
...
write.csv(final_df, "~/NPI/code_output/tables/lb_ttest.csv")
