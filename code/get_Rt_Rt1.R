...
for (param_set in param_sets) {
  ...
  sufficient_ncluster_res <- read.csv(paste0("~/Desktop/res/res_", tgt_R0, "_", N_cluster, "_", k_overdispersion, "_", effect, "_", expected_It_N, "_", nsample, ".csv"), header=F)
  ...
  colnames(new_row) <- c("E_It", "N", "R0", "k", "effect", "mean_Rt0", 
...
write.csv(final_df, "~/Desktop/lb.csv")
