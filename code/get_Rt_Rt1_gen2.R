...
for (param_set in param_sets) {
  ...
  It_It1con_It1trt <- read.csv(paste0("~/Desktop/res/", tgt_R0, "_", N_cluster, "_", k_overdispersion, "_", effect, "_", expected_It_N, ".csv"), header=F)
  ...
  sufficient_ncluster_res <- read.csv(paste0("~/Desktop/res/res_", tgt_R0, "_", N_cluster, "_", k_overdispersion, "_", effect, "_", expected_It_N, "_", nsample, "_ttest_gen2.csv"), header=F)
  ...
  for (sim_num in 1:nrow(It_It1con_It1trt)) {
    ...
    It1_con <- It_It1con_It1trt[sim_num,11]
    It1_trt <- It_It1con_It1trt[sim_num,23]
    Its <- c(Its, It)
...
write.csv(final_df, "~/Desktop/lb_gen2.csv")
