...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 15 06:15:07 2021

@author: jsheen

@description: sensitivity analysis deg 8
"""
...
for param_set in param_sets:
    ...
    beta_and_day = pd.read_csv(home + "/NPI/code_output/prelim/" + str(tgt_R0) + "_" + str(N_cluster) + "_" + str(k_overdispersion) + "_" + str(expected_It_N) + "_deg8.csv", header=None)
    ...
    filename = home + "/NPI/code_output/res/" + str(tgt_R0) + "_" + str(N_cluster) + "_" + str(k_overdispersion) + "_" + str(effect) + "_" + str(expected_It_N) + "_deg8.csv"
