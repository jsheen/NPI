...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 15 02:35:57 2021

@author: Justin Sheen

@description: algorithm to find sufficient number of clusters three generations
...
for param_set in param_sets:
    ...
    filename = home + "/NPI/code_output/res/res_" + str(tgt_R0) + "_" + str(N_cluster) + "_" + str(k_overdispersion) + "_" + str(effect) + "_" + str(expected_It_N) + "_" + str(curr_nsample) + "_ttest_gen3.csv"
