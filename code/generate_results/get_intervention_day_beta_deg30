...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 12 15:57:10 2021
...
for param_set in param_sets:
    ...
    for day_dex in range(nsim):
        ...
        if statistics.mean(focal_dist) >= expected_It_N:
            ...
            break
    # Write output ------------------------------------------------------------    
    filename = home + "/NPI/code_output/prelim/" + str(tgt_R0) + "_" + str(N_cluster) + "_" + str(k_overdispersion) + "_" + str(expected_It_N) + "_deg30.csv"
