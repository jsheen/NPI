...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 12

@author: Justin Sheen

@description: sensitivity analysis deg 30
"""
...
for param_set in param_sets:
    ...
    filename = home + "/NPI/code_output/res/" + str(tgt_R0) + "_" + str(N_cluster) + "_" + str(k_overdispersion) + "_" + str(effect) + "_" + str(expected_It_N) + "_deg30.csv"
