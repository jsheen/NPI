...
# For each parameter set, create 10,000 simulations ---------------------------
for param_set in param_sets:
    ...
    # Find median beta that leads to desired tgt_R0 (300 sims) ----------------
    ...
    filename = "/Users/jsheen/Desktop/res/" + str(tgt_R0) + "_" + str(N_cluster) + "_" + str(k_overdispersion) + "_" + str(effect) + "_" + str(expected_It_N) + "_day28.csv"
