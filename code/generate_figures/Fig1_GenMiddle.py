...
with open(home + '/NPI/code_output/figs/Fig1_pickles/sims_con_lowE.pickle', 'wb') as handle:
    pickle.dump(sims_con, handle, protocol=pickle.HIGHEST_PROTOCOL)
with open(home + '/NPI/code_output/figs/Fig1_pickles/sims_trt_lowE.pickle', 'wb') as handle:
