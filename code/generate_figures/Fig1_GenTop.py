...
with open(home + '/NPI/code_output/figs/Sheen_Fig1_pickles/sims_con.pickle', 'wb') as handle:
    pickle.dump(sims_con, handle, protocol=pickle.HIGHEST_PROTOCOL)
with open(home + '/NPI/code_output/figs/Sheen_Fig1_pickles/sims_trt.pickle', 'wb') as handle:
