...
ggsave(filename="~/NPI/code_output/figs/Sheen_Fig5.tiff", marrangeGrob(grobs = l, nrow=2, ncol=3, top=NULL),
       width=8, height=12, units='in', dpi=600)
ggsave(filename="~/NPI/code_output/figs/Sheen_Fig5.png", marrangeGrob(grobs = l, nrow=2, ncol=3, top=NULL),
...
ggsave(filename="~/NPI/code_output/figs/Sheen_Fig5_Fig6_FigS3_legend.tiff", mylegend,
       width=12, height=1, units='in', dpi=600)
ggsave(filename="~/NPI/code_output/figs/Sheen_Fig5_Fig6_FigS3_legend.png", mylegend,
