...
ggsave(filename="~/NPI/code_output/figs/Sheen_FigS4.tiff", marrangeGrob(grobs = ps, nrow=4, ncol=1, top=NULL),
       width=13, height=16, units='in', dpi=600)
ggsave(filename="~/NPI/code_output/figs/Sheen_FigS4.png", marrangeGrob(grobs = ps, nrow=4, ncol=1, top=NULL),
...
ggsave(filename="~/NPI/code_output/figs/Sheen_FigS4_legend.tiff", mylegend,
       width=12, height=1, units='in', dpi=600)
ggsave(filename="~/NPI/code_output/figs/Sheen_FigS4_legend.png", mylegend,
