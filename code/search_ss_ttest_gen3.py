...
for param_set in param_sets:
    ...
    filename = "/Users/jsheen/Desktop/res/res_" + str(tgt_R0) + "_" + str(N_cluster) + "_" + str(k_overdispersion) + "_" + str(effect) + "_" + str(expected_It_N) + "_" + str(curr_nsample) + "_ttest_gen3.csv"
