...
# @author: Justin Sheen
#
# @description: script to create csv of sensitivity analysis with degree 30
#
# ------------------------------------------------------------------------------
# Get all parameters -----------------------------------------------------------
param_sets <- c()
...
for (param_set in param_sets) {
  ...
  It_It1con_It1trt <- read.csv(paste0("~/NPI/code_output/res/", tgt_R0, "_", N_cluster, "_", k_overdispersion, "_", effect, "_", expected_It_N, "_deg30.csv"), header=F)
  ...
  sufficient_ncluster_res <- read.csv(paste0("~/NPI/code_output/res/res_", tgt_R0, "_", N_cluster, "_", k_overdispersion, "_", effect, "_", expected_It_N, "_", nsample, "_ttest_deg30.csv"), header=F)
...
write.csv(final_df, "~/NPI/code_output/tables/ttest_deg30.csv")
