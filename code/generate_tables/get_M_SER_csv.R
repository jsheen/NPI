...
for (param_set in param_sets) {
  ...
  sufficient_ncluster_res <- read.csv(paste0("~/NPI/code_output/res/res_", tgt_R0, "_", N_cluster, "_", k_overdispersion, "_", effect, "_", expected_It_N, "_", nsample, "_M_SER.csv"), header=F)
...
write.csv(final_df, "~/NPI/code_output/tables/M_SER.csv")
