...
# @author: Justin Sheen
#
# @description: script to create csv of ttest rerun results (one generation after intervention)
#
# ------------------------------------------------------------------------------
...
for (param_set in param_sets) {
  ...
  sufficient_ncluster_res <- read.csv(paste0("~/NPI/code_output/res/res_", tgt_R0, "_", N_cluster, "_", k_overdispersion, "_", effect, "_", expected_It_N, "_", nsample, "_ttest_rerun.csv"), header=F)
...
write.csv(final_df, "~/NPI/code_output/tables/ttest_rerun.csv")
