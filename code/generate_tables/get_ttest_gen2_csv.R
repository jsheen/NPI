...
# @author: Justin Sheen
#
# @description: script to create csv of ttest results (two generations after intervention)
#
# ------------------------------------------------------------------------------
# Get all parameters -----------------------------------------------------------
param_sets <- c()
...
for (param_set in param_sets) {
  ...
  sufficient_ncluster_res <- read.csv(paste0("~/NPI/code_output/res/res_", tgt_R0, "_", N_cluster, "_", k_overdispersion, "_", effect, "_", expected_It_N, "_", nsample, "_ttest_gen2.csv"), header=F)
