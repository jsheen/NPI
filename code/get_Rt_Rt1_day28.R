...
for (param_set in param_sets) {
  ...
  It_It1con_It1trt <- read.csv(paste0("~/Desktop/res/", tgt_R0, "_", N_cluster, "_", k_overdispersion, "_", effect, "_", expected_It_N, "_day28.csv"), header=F)
  ...
  sufficient_ncluster_res <- read.csv(paste0("~/Desktop/res/res_", tgt_R0, "_", N_cluster, "_", k_overdispersion, "_", effect, "_", expected_It_N, "_", nsample, "_day28.csv"), header=F)
...
write.csv(final_df, "~/Desktop/lb_day28.csv")
