...
plt.scatter(df['true_beta'].loc[np.where((df['k'] == 0.1) & (df['N'] == 1000))], df['beta_est'].loc[np.where((df['k'] == 0.1) & (df['N'] == 1000))], c='blue', marker='s')       
plt.scatter(df['true_beta'].loc[np.where((df['k'] == 0.4) & (df['N'] == 1000))], df['beta_est'].loc[np.where((df['k'] == 0.4) & (df['N'] == 1000))], c='orange', marker='s')       
plt.scatter(df['true_beta'].loc[np.where((df['k'] == 0.7) & (df['N'] == 1000))], df['beta_est'].loc[np.where((df['k'] == 0.7) & (df['N'] == 1000))], c='red', marker='s')
